...
different locations can be selected and related graphs are also given -->
<!DOCTYPE html>
<html>
  <head>
        <meta charset="utf-8">
          ...
          <div class="row">
            <div class="col-md-1"></div>
              <div class="col-md-10" style="margin-left: 8%">
                ...
                <iframe src="map.html" width="100%" height="1600px" style="border-width: 0px; border: soild;"></iframe>
              </div>
            <div class="col-md-1"></div>
          </div>
        </div>
