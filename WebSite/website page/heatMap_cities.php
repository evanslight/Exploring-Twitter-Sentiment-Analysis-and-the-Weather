...
<!-- Date: 30 Oct 2015 -->
<!-- weather condition analysis of Australian cities displayed in graphs -->
<!DOCTYPE html>
<html>
  <head>
        <meta charset="utf-8">
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-1"></div>
              ...
              <h4 style="margin-left: 15%">Emotion Situation For Different Weather Condition (8 Cities)</h4>
                <iframe src="city_weather_condition.html" width="100%" height="900px" style="border-width: 0px; border: soild;"></iframe>
              </div>
            <div class="col-md-1"></div>
          </div>
        </div>
