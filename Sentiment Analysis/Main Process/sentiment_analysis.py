...
# Description : This program is used to analysis sentiment, this program
#               has been invoked by tweeter fetching and interaction program
#               but just present different result
#######################################################################
...
if __name__ == '__main__':
    ...
    while (1):
    	...
    	x = raw_input("Please input your text here:")

    	doc ={"text":"ok","textInfo":{"media":None}}
    	print learn(doc,row[0],row[1],row[2])
